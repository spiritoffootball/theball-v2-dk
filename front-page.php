...
<?php if ( $mission_loop = locate_template( 'template-parts/loop-missions.php' ) ) : ?>
	<?php load_template( $mission_loop ); ?>
<?php endif; ?>

<?php if ( $activity_loop = locate_template( 'template-parts/loop-activities.php' ) ) : ?>
	<?php load_template( $activity_loop ); ?>
<?php endif; ?>

<?php if ( $method_loop = locate_template( 'template-parts/loop-methods.php' ) ) : ?>
	<?php load_template( $method_loop ); ?>
<?php endif; ?>

<?php if ( $gateway_loop = locate_template( 'template-parts/loop-gateways.php' ) ) : ?>
	<?php load_template( $gateway_loop ); ?>
<?php endif; ?>

<?php if ( $sof_org_loop = locate_template( 'template-parts/loop-sof-orgs.php' ) ) : ?>
	<?php load_template( $sof_org_loop ); ?>
<?php endif; ?>
